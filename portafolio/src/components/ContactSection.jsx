...
export default function ContactSection() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_yadkn5e', 'template_ozg3jnn', form.current, '8-QF7V25dAO8EufiE')
            .then((result) => {
    ...
    return (
        <div id='contact' className="bg-transparent isolate px-6 py-24 sm:py-32 lg:px-8">
            <div
            ...
            <div className="mx-auto max-w-2xl text-center">
                ...
                <p className="mt-2 text-lg leading-8 text-gray-400">
                    ...
                    <span className="underline">andressolarte580@gmail.com</span>, +57 3028471671 or by filling out this form.
                </p>
